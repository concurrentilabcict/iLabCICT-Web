            ...
            <div className={isSearchActive ? 'hidden md:block' : ''}>
                ...
                >
                    <DropdownMenuTrigger asChild>
                        <button
                            type="button"
	                            className='flex items-center justify-between gap-x-5 rounded-xl bg-white px-3 py-2 secondary-text-color shadow-[0_4px_14px_rgba(15,23,42,0.08)] cursor-pointer md:w-40'
                        >
