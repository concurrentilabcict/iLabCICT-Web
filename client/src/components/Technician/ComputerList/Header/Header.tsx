...
type headerProps = {
    computerListName: string
}
export default function ComputerListHeader({computerListName}:headerProps){
            ...
            <div className="bg-white flex items-center justify-between p-5 border-b border-b-[#e5e5e5]">
                <div className='flex items-center gap-x-2'>
                    ...
                    <div className='primary-bg-color rounded-sm p-2'>
                        ...
                        <h1 className='text-lg font-medium'>{computerListName.toUpperCase()}</h1>
                </div>
                <span>profile</span>
            </div>
        </>
