        ...
        <div className="flex items-center justify-between gap-x-2 px-3 py-3">
            ...
            >
                ...
                <input
                    ...
                    className="bg-white w-full rounded-md border primary-border-color py-2 pl-10 pr-10 outline-none focus:border-black!"
                />
            ...
            <div className={isSearchActive ? 'hidden md:block' : ''}>
                ...
                >
                 ...
                 cursor-pointer secondary-text-color justify-between md:w-40'
                        >
