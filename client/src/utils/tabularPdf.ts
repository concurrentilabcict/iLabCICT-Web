...
export const exportTablePdf = ({
  ...
  const pageWidth = orientation === "landscape" ? "14in" : "8.5in";
  const pageHeight = orientation === "landscape" ? "8.5in" : "14in";
  ...
  targetWindow.document.write(`
    ...
    <html>
      <head>
        ...
        <style>
          @page { size: legal ${orientation}; margin: 0.45in; }
      ...
      <body>
        <main class="document">
          ...
          <footer class="footer">
            ...
            <span>Legal paper - Page <span class="page-number"></span></span>
          </footer>
        </main>
        <script>
