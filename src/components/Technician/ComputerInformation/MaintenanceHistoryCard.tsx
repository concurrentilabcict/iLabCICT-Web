                ...
                rounded-2xl p-3.5 w-full max-w-[600px] md:max-w-[550px] h-full">
                    ...
                    <div className="flex flex-col gap-1.5 overflow-y">
                        ...
                        <div className="flex gap-2 items-start">
                            ...
                            <div className="shrink-0 bg-[#F3E8FF] p-2 rounded-md">
                                <CodeSquare
                                   size={32}
                            ...
                            <div className="flex flex-col gap-0.5">
                                <div className="flex gap-2 items-center">
                                    <span className="font-semibold text-sm">TK-2025-067</span>
                                    <span className="font-medium text-[#9333EA] text-xs px-1.5 py-1 bg-[#F3E8FF] rounded-md">Software</span>
                                </div>

                                <div className="flex gap-1 items-center">
                                    <span className="secondary-text-color text-xs">Visual Studio Not Working</span>
                                    <span className="secondary-text-color text-xs">-</span>
                                    <span className="secondary-text-color text-xs">Resolved</span>
                                </div>
